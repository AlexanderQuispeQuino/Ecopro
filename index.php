...
<body>
 ...
 -->
						...
						<li>
							<!-- href="aula.html" --> 
							<a data-toggle="modal" data-target="#mylogin" onmouseover="javascript:this.style.color='#24CB31';">Aula Virtual</a>
						</li>
...
<!-- inicioModalClientes -->
  ...
  <div class="modal fade" id="clientes" role="dialog">
    <div class="modal-dialog">
      ...
      <!-- Modal content-->
      <div class="modal-content" style="height: 862px;">
        ...
        <div class="clientes column">
          <div>
            ...
            <figure>
              <a href="http://cmslsa.com/" target="_blank"><img src="img/logos/1_Mesa de trabajo 1.jpg" alt=""></a>
          ...
          <figure>
           <a href="http://www.tahoeresources.com/spanish/operaciones/mina-shahuindo/"  target="_blank"> <img src="img/logos/3_Mesa de trabajo 1.jpg" alt=""  ></a>
          </figure>

          <figure>
           <a href="http://www.tahoeresources.com/spanish/operaciones/mina-la-arena/"  target="_blank"> <img src="img/logos/4_Mesa de trabajo 1.jpg" alt=""  ></a>
          </figure>
           
          <figure>
           <a href="http://www.soltrak.com.pe/"  target="_blank"> <img src="img/logos/6_Mesa de trabajo 1.jpg" alt=""  ></a>
          </figure>

          <figure>
            <a href="http://stracon.com/inicio" target="_blank"> <img src="img/logos/8_Mesa de trabajo 1.jpg" alt=""  ></a>
          </figure>

          <figure>
             <a href="http://sanmartin.com/"  target="_blank"> <img src="img/logos/5_Mesa de trabajo 1.jpg" alt=""   ></a>
          </figure>

          <figure>
           <a href="https://imecon.com.pe/"  target="_blank"> <img src="img/logos/7_Mesa de trabajo 1.jpg" alt=""   ></a>
          </figure>  
          
          <figure> 

           <a href="http://www.galvec.com/"  target="_blank"> <img src="img/logos/9_Mesa de trabajo 1.jpg" alt=""   ></a>
          </figure>

          <figure>
           <a href="http://www.unimaq.com.pe/"  target="_blank"> <img src="img/logos/14_Mesa de trabajo 1.jpg" alt=""   ></a>
          </figure> 

          <figure>
           <a href="http://www.shouxin.com.pe/"  target="_blank"> <img src="img/logos/11_Mesa de trabajo 1.jpg" alt=""   ></a>
          </figure>

          <figure>
           <a href="http://www.unicon.com.pe/principal/categoria/mineria/152/c-152" target="_blank"> <img src="img/logos/12.jpg" alt=""   ></a>
          </figure>
          ...
          <figure>
           <a href="https://www.ais.com.pe/"  target="_blank"> <img src="img/logos/10_Mesa de trabajo 1.jpg" alt=""   ></a>
          </figure>

           <figure>
           <a href="http://www.shougang.com.pe/"  target="_blank"> <img src="img/logos/15_Mesa de trabajo 1.jpg" alt=""   ></a>
          </figure>

          <figure>
           <a href="http://www.buenaventura.com/es/" target="_blank"> <img src="img/logos/16_Mesa de trabajo 1.jpg" alt=""    ></a>
          </figure>
...
<div class="container">
  ...
  <div class="modal fade" id="mylogin" role="dialog">
    <div class="modal-dialog" style="width: 600px;">
      ...
      <!-- Modal content-->
      <div class="modal-content" style="width: 600px; height: 622px;">
        <div class="modal-header" style="padding:35px 50px;">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4><span class="glyphicon glyphicon-lock"></span> Login</h4>
        </div>
        <div class="modal-body" style="padding:40px 50px;  height:480px; display: block;">

        	<figure class="login" style="display: flex;justify-content: center;">
        		<img src="img/login.jpg" alt="login" style="width: 150px; height: 150px; border-radius: 50%; ">
        	</figure>
          <form role="form" style="width: -webkit-fill-available; height: 220px;">
            <div class="form-group">
